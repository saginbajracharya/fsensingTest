                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        const LableWidget(lableText: 'API'),
                        const SizedBox(
                          height: 5,
                        ),
                        TextFormField(
                          controller: homeCon.apiEndPointUrl,
                          enabled: homeCon.start.value==1?false:true,
                          decoration: InputDecoration(
                            fillColor: white,
                            suffixIcon: IconButton(
                        ...
                        TextFormField(
                          controller: homeCon.intervalSecond,
                          enabled: homeCon.start.value==1?false:true,
                          textInputAction: TextInputAction.done,
                          decoration: InputDecoration(
                            fillColor: white,
